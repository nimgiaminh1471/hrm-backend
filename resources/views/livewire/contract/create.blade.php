...
new class extends Component {
    ...
    public function rules()
    {
        return [
            ...
            'type' => 'required|string|in:' . implode(',', ContractType::values()),
    ...
    public function save()
    {
        ...
        $this->success('Contract created successfully.', redirectTo: route('contracts'));
    }
...
?>
<div>
    <x-header title="Add New Contract" separator progress-indicator>
        <x-slot:actions>
            <x-button label="Cancel" wire:click="back" />
        </x-slot:actions>
    </x-header>
